...
function CourseDetailsContent() {
  ...
  // Fetch course bookings list
  const fetchBookings = async () => {
    try {
      setBookingsLoading(true);
      const res = await bookingApi.getCourseAttendees(courseId, {
        page: bookingsPage,
        limit: 10,
  ...
  useEffect(() => {
    if (courseId && activeTab === "bookings") {
      fetchBookings();
    }
  }, [courseId, activeTab, bookingsPage, bookingsSearch]);
  ...
  }, [courseId, activeTab, analyticsFilter]);
                    ...
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div className="flex-1" style={{ minWidth: 0 }}>
                        <div className="d-flex align-items-center gap-2 flex-wrap">
                          ...
                          {booking.isFullyCheckedIn && (
                            <span className="badge-checked-in">✓ Checked In</span>
                          )}
                        </div>
                        {booking.enrolledBatches && booking.enrolledBatches.length > 0 ? (
                          <div className="d-flex flex-wrap gap-1 mt-1">
                            {booking.enrolledBatches.map((b, bi) => (
                              <span key={bi} className="badge-status visibility" style={{ fontSize: "10px", padding: "2px 6px" }}>
                          ...
                          <p className="booking-ticket-info mb-0">
                            {t("enrolled") || "Enrolled"} × {booking.qty || 1}
                          </p>
                        )}
