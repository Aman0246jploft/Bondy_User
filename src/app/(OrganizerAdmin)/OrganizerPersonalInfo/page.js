...
function PersonalInfoContent() {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      toast.error(
        error.message || t("profileUpdateFailed") || "Failed to update profile",
      );
    } finally {
      setLoading(false);
    }
              ...
              <div className="personal-profile-info">
                ...
                <div className="stats-row mt-2 d-flex align-items-center gap-3 flex-wrap" style={{ fontSize: "14px", color: "#aaa" }}>
                  {profileData.role !== "CUSTOMER" && (
                    ...
                    >
                      <img src="/img/user_icon.svg" alt="followers" style={{ marginRight: "5px" }} />
                      {profileData.totalFollowers || 0} {t("followers")}
                    </span>
                  )}
                  <span
                    style={{ cursor: "pointer", whiteSpace: "nowrap" }}
                  ...
                  >
                    <img src="/img/user_icon.svg" alt="following" style={{ marginRight: "5px" }} />
                    {profileData.totalFollowing || 0} {t("following")}
                  </span>
                  {profileData.role === "ORGANIZER" && (
                    ...
                    >
                      ...
                      {profileData.averageRating || 0}/5 {t("rating")} ({profileData.reviewCount || 0})
                    </span>
                  )}
                </div>
              </div>
